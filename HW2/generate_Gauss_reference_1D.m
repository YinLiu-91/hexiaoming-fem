...
if Gauss_point_number==4
    Gauss_coefficient_reference_1D=[0.3478548451,0.3478548451,0.6521451549,0.6521451549]; % 高斯积分点权重
    Gauss_point_reference_1D=[0.8611363116,-0.8611363116,0.3399810436,-0.3399810436]; % 高斯积分点位置
