function b=treat_Neumann_boundary_time_triangle(Neumann_boundary_function_name,time_n_plus_1,time_n,theta,b,boundary_edges,M_partition,T_partition,T_basis_test,number_of_test_local_basis,Gauss_coefficient_reference_1D,Gauss_point_reference_1D,test_basis_type,test_derivative_degree_x,test_derivative_degree_y)
%Xiaoming He, 07/23/2009.
%Deal with Neumann boundary condition depending on time.
%We will use "FE" to replace "finite element" in the comments.
%Neumann_boundary_fucntion_name: the name of the Neumann boundary function \tilde{q}(x,y) in my notes "Notes for tool box of standard triangular FE" section 3-2-2.
...
%More explanation is in my "Notes for tool box of standard triangular FE" section 3-2-2.
