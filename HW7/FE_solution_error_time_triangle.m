function r=FE_solution_error_time_triangle(uh,accurate_function,checked_time,left,right,bottom,top,h_partition,basis_type,derivative_degree_x,derivative_degree_y,Gauss_point_number)
...
for n=1:number_of_elements
    ...
    r=r+Gauss_quad_for_volume_integral_FE_solution_error_time_triangle(uh_local,accurate_function,checked_time,vertices,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,basis_type,derivative_degree_x,derivative_degree_y);
end
r=sqrt(r);