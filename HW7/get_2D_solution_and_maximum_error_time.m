function [solution_2D,maxerror]=get_2D_solution_and_maximum_error_time(checked_time,solution_1D,N1_basis,N2_basis,left,bottom,h_basis)
...
for i=1:N1_basis+1
   for j=1:N2_basis+1
      ...
      temp=solution_2D(j,i)-exact_solution(checked_time,left+(i-1)*h_basis(1),bottom+(j-1)*h_basis(2));
