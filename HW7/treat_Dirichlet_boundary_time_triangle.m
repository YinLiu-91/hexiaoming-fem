function [A,b]=treat_Dirichlet_boundary_time_triangle(Dirichlet_boundary_function_name,current_time,A,b,boundary_nodes,M_basis)
...
%Also i=boundary_nodes(2,k) if boundary_nodes(1,k)==-1.
    ...
    if boundary_nodes(1,k)==-1 
        ...
        A(i,:)=0;
        A(i,i)=1;
        b(i,1)=feval(Dirichlet_boundary_function_name,current_time,M_basis(1,i),M_basis(2,i));
    end
