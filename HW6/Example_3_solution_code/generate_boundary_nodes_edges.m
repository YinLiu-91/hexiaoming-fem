...
%first set all nodes as Dirichlet boundary nodes.
boundary_nodes(1,:)=-1;
%Modify the bottom boundary nodes to be Robin.
for k=2:N1_basis
    boundary_nodes(1,k)=-3;
end
...
boundary_edges(1,:)=-1;
%Modify the bottom boundary edges to be Robin.
